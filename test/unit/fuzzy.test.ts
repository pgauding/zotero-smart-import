...
describe("fuzzy", () => {
  describe("levenshteinDistance", () => {
    ...
    it("should handle longer substitutions", () => {
  ...
  describe("levenshteinRatio", () => {
    ...
    it("should return expected ratio for known pair", () => {
  ...
  describe("tokenSortRatio", () => {
    ...
    it("should return 1.0 for reordered words", () => {
      assert.equal(
    ...
    it("should score high for very similar titles", () => {
    ...
    it("should score lower for different titles", () => {
      const score = tokenSortRatio(
        "The Nature and Origins of Mass Opinion",
    ...
    it("should handle real title near-matches", () => {
    ...
    it("should handle titles that differ by subtitle", () => {
      const score = tokenSortRatio(
  ...
  describe("tokenSetRatio", () => {
    ...
    it("should return 1.0 when one is a subset of the other", () => {
    ...
    it("should handle author name matching well", () => {
    ...
    it("should score reasonably for partial author overlap", () => {
      const score = tokenSetRatio(
    ...
    it("should score low for completely different authors", () => {
      const score = tokenSetRatio(
        "Gelpi, Christopher",
        "Zaller, John R.",
      );
  ...
  describe("yearSimilarity", () => {
    ...
    it("should return 0.0 when either is null", () => {
    ...
    it("should return 0.0 for non-numeric input", () => {
      assert.equal(yearSimilarity("abc", "2020"), 0.0);
      assert.equal(yearSimilarity("2020", "def"), 0.0);
    });
  });

  describe("end-to-end scoring simulation", () => {
    ...
    it("should score > 0.75 for an exact match", () => {
    ...
    it("should score > 0.75 for a match with minor title differences", () => {
      const score = compositeScore(
    ...
    it("should score < 0.40 for clearly different works", () => {
      const score = compositeScore(
        "Gun Crusaders: The NRA's Culture War",
        "Melzer, Scott",
        "2009",
      ...
      assert.isBelow(score, 0.40);
    });

    it("should score high for same work even if year off-by-one", () => {
      const score = compositeScore(
